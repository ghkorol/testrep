...
where the smallest $k$ defines the leading order. The \textit{Parton Density Function}, or the \textit{PDF}, is depending on the parton flavour $i$, parton longitudinal momentum
...
The momentum fractions $x_{1}$ and $x_{2}$ for the interaction of two protons with the same energy $E_{p}$ producing a $t\bar{t}$ pair can be expressed following 
