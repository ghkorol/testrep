...
The presence of two undetected neutrinos introduces six unknowns to the $t\bar{t}$ system in the dilepton final state.
The problem of two not fully reconstructed neutrinos is  solved by setting certain constrains:
