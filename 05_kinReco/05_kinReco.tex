...
momentum directions. That will increase the efficiency of finding a solution of the system of equations (\ref{alg:LS1}--\ref{alg:LS6}). This idea was implemented by reconstructing
each event 100 times, each time varying relevant observables randomly and independent according to their resolution determined from the Monte Carlo.
