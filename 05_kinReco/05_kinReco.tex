\chapter{Reconstruction of the Top Kinematics}\label{chapt:kinReco}

As presented in previous chapter, the $t\bar{t}$ dileptonic final state does not have a complete reconstruction 
of the top kinematics. Two neutrinos are not detected and only their transverse energy can be measured. Thus additional
