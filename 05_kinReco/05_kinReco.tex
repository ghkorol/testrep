...
The distribution of the number of solutions for the generated $t\bar{t}$ signal sample (\MG + \PYTHIA,
see chapt. \ref{chapt:MC}) is shown in Figure \ref{fig:LSNsol}. Two (four) solutions per event are expected in approx. 80$\%$ (20\%) of the cases.
...
lepton and $b$-jets kinematics and missing transverse energy. The integrated efficiency of the kinematic reconstruction method is 93 $\%$. Overall, the scale factors 
