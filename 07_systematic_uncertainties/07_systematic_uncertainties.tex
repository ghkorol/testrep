...
Every background normalization is scaled up and down by conservative 30$\%$ which should have taken to account all the shape differences
and uncertainties.
...
Model uncertainty is defined by using different simulation data obtained from the different generators and/or setting
...
The proton structure on the generator level is defined by the set of the PDFs (see sec. \ref{}). To check the possible biases 
introduced by this assumption the different set of the PDFs, namely XXX, was used for the generator input and the analysis results
were compared to the nominal once. This procedure follows the expert's recommendations \cite{}.
