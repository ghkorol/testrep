...
As measurement of \textit{normalized} double differential production cross section $\frac{1}{\sigma} \frac{d\sigma}{dx\:dy}$
...
The proton structure parametrization used in the vent generation are defined by the set of PDFs (see sec. \ref{ssec:tprod}). To check for possible biases 
introduced by this choice a different set of PDFs, namely XXX, was used for the generator input and the analysis results
were compared to the nominal ones. This procedure follows the expert's recommendations \cite{}.
