...
tasks provide special requirements for specific experimental setup parts. For instance, if the plan is to measure Standard Model decays
($W$, $H$, $Z'$ decays with leptons in final state), the detector complex has to comprise a precise electromagnetic calorimetry and 
muon systems for a better lepton reconstruction. To measure the hadronic decays and higher order QCD with jets in final states, a
good tracking and calorimetry have to provide absolute energy determinations. To look for heavy resonances one needs a well granulated
and precise detection in the central region, perpendicular to the beam direction. Unlike for the low mass particles, where the tracking
