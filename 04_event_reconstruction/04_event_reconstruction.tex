...
\begin{itemize}
 \item \textbf{Tracker driven seeding}: The tracks with $p_{T} < 5$ GeV from the tracking detector are matched to the superclusters in the ECAL\footnote
 {A \textit{supercluster} is  a group of one or more associated clusters of energy deposits in the ECAL. The transverse energy of a supercluster has to be $E_{T} > \textrm{4 GeV}$}.
