...
A jet may arise from any quark or gluon. However The task for this analysis is to distinguish a jet from a $b$ from the other jets. In particular,
...
The other important parameter which can be used to identify the jet origin is the impact parameter of the tracks arising from the secondary vertex. The discussed properties are 
displayed in Figure \ref{fig:SV}.
