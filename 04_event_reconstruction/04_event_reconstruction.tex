...
\begin{itemize}
 ...
 The Scale Factors connected to the trigger selection were applied on the MC data. They were derived double-differentially in bins of two leptons rapidities. 
 %%%%% 
