...
algorithm \cite{Beaudette:2014cea}. It is an iterative process which reconstructs the particles and one by one exploiting the information from all parts
...
The PF algorithm relies on an efficient track reconstruction,
