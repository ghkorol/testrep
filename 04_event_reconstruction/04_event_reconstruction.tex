...
\begin{itemize}
 \item \textit{Offset correction} removes extra energy due to electronics noise and pile-up.
 %
 ...
 particle jets. This correction is performed in bins of the jets $p_{T}$ and $\eta$.
 %
