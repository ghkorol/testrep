...
The electrons are reconstructed by comining the tracks from tracker with the clusters from ECAL. The electron seeds
...
using the hypothesis that each track is an electron.
