...
The first calibration step deals with the additional energy in the jet which does not occur from a hard process but rather from the detector noise or pile up. 
...
secondary vertex and track impact parameter (see Fig. \ref{fig:SV}) to the primary vertex.
...
\begin{figure}[t]
  ...
  data. The plot is taken from \cite{}.}
  \label{fig:METres}
\end{figure}
