...
simulation. The overall differences of the experimental data and MC distributions is corrected via reweighing the simulation rates towards the experimental once.
...
\begin{itemize}
 ...
 The efficiency of the trigger selection was determined in the experimental and reconstructed simulated data separately. The Scale Factors connected to the
 trigger selection were applied on the MC data. They were derived double-differentially in bins of two leptons rapidities. 
 %%%%% 
