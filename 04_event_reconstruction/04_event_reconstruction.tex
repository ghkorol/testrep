...
with the similar final state signature and increase the signal quality is presented. The selection is based on the CMS Top-Quark-Physics-Analysis group recommendations \cite{TopPAGreco}.
...
Given the tracks and vertecies and making use of calorimeter and muon system signals the pattern recognition is possible. 
This section describes the algorithms of the $t\bar{t}$ final state objects reconstruction (muons, electrons, jets and missing transverse energy).
