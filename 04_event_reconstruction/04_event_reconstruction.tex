...
\begin{itemize}
 ...
 particle jets. This correction is performed in bins of the jets $p_{T}$ and $\eta$. Applied on the real and simulated reconstructed data.
 %
 \item \textit{Relative jet energy correction} ensures a flat response depending on $\eta$. 
\end{itemize}
