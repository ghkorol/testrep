...
The double differential $t\bar{t}$ production cross sections are shown in Fig. \ref{fig:XS_2D_x1_Mtt}. The models do not describe the high $x_{1}$ region. The 
...
cross sections, measured in dilepton channel at the center-of-mass energy $\sqrt{s} = 8\;\text{TeV}$ (TOP-12-028) \cite{Khachatryan:2015oqa}.
...
\begin{center}
 \begin{tabular}{| c | c |}
  ...
  In bins of $p_{T}(t)$			& Measurement is softer than theory predictions \\ \hline 
  In bins of $y(t)$			& Measurement is less central than predictions \\ \hline 
  In bins of $p_{T}(t\bar{t})$		& Theory predicts more $t\bar{t}$ pairs with high $p_{T}$ \\ \hline 
  In bins of $y(t\bar{t})$		& Measurements are more central in $y(t\bar{t})$ \\ \hline
...
To check these effects listed in the table above in more detail, one could look at them double differentially.
...
The effect, that the $p_{T}(t)$ spectrum is softer in the measured distributions than in the predictions, is also observed in the double differential 
cross sections in bins of $p_{T}(t)$ and $|y(t)|$ (see Fig. \ref{fig:XS_2D_y_pt}).

The effect observed for the single differential $p_{T}(t\bar{t})$ spectrum may be explained by the overestimation of the amount of hard radiation
in the predictions, which leads to the strong momentum distortion, thus resulting higher $p_{T}$ of the $t\bar{t}$ system. This effect is the weakest 
